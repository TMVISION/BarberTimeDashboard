...
var barbeirosService = {
    ...
    getBarbeiro: async()=>{
        var barbeirosApi = axios.get(`https://barbertimeapi.vercel.app/api/funcionarios/barbeiro`);
        //var barbeirosApi = axios.get(`https://barbertimeapi.vercel.app/api/funcionarios/barbeiro`);
    ...
    createFuncionario: async(barbeiro,id)=>{
        try {
            var barbeirosApi = axios.post(`https://barbertimeapi.vercel.app/api/funcionarios`,barbeiro,id);
        //var barbeirosApi = axios.get(`https://barbertimeapi.vercel.app/api/funcionarios/`+id);
        return await barbeirosApi;
        } catch (error) {
            alert(error);
    ...
    getAllFuncionarios: async() =>{
        try {
            var barbeirosApi = axios.get(`https://barbertimeapi.vercel.app/api/funcionarios`);
        //var barbeirosApi = axios.get(`https://barbertimeapi.vercel.app/api/funcionarios/`+id);
        return await barbeirosApi;
        } catch (error) {
            alert(error);
    ...
    deletefuncionarios: async(id) => {
        var funcionarioAPI = axios.delete(`https://barbertimeapi.vercel.app/api/funcionarios/${id}`);
      ...
      updateFuncionarios: async(id, funcionario) => {
        ...
        var funcionarioAPI = axios.put('https://barbertimeapi.vercel.app/api/funcionarios/'+id, funcionario);
        return await funcionarioAPI;  
